...
class SATNet(BaseModule):
    """
    Based on "Show, Attend and Tell" structure
    ResNet - Soft Attention - LSTM
    """
    def __init__(self, hp):
        super(SATNet, self).__init__(hp)
        ...
        self.decoder = DecoderWithAttention(
            ...
            hp.model.embedding_dim,
            hp.model.decoder_dim,
            vocab_size=HangulUtil.vocabulary_size(),
    ...
    def forward(self, batch):
        ...
        return scores, targets, alphas

    def configure_optimizers(self):
        params = [self.encoder.parameters(), self.decoder.parameters()]
        lrs = [self.hp.train.encoder_lr, self.hp.train.decoder_lr]

        optimizers = [Adam(params[i], lr=lrs[i]) for i in (0, 1)]
        schedulers = [{
...
# Based on https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Image-Captioning
